/**
    ...
    `CFFGLPluginInfo` that Porthole.cpp registers at static-initialisation time.
    ...
    binary: which build it is.
        ...
        strings Porthole.bundle/Contents/MacOS/Porthole | grep porthole
*/

extern "C" const char* PortholeBuildStamp()
{
	return "porthole " PORTHOLE_VERSION " built " __DATE__ " " __TIME__;
}
