/*
 * Stoatworks Labs - About window data for Porthole.
 *
...
{
    inline constexpr auto name = "Porthole";
    inline constexpr auto slug = "porthole";
    inline constexpr auto hook = "Fisheye and defish for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/porthole/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/porthole/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/porthole";
    inline constexpr auto versionFallback = "v0.2.1";
