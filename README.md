...
**[v1.0.5](https://github.com/stoatworks-labs/porthole/releases/tag/v1.0.5)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`porthole-1.0.5-macos-universal.dmg`](https://github.com/stoatworks-labs/porthole/releases/download/v1.0.5/porthole-1.0.5-macos-universal.dmg) | 195 KB |
| Universal (Apple Silicon + Intel) · .zip archive | [`porthole-macos-universal.zip`](https://github.com/stoatworks-labs/porthole/releases/latest/download/porthole-macos-universal.zip) | 160 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`porthole-1.0.5-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/porthole/releases/download/v1.0.5/porthole-1.0.5-windows-x86_64-setup.exe) | 213 KB |
